...
This directory is the local standards index for `@sdkwork/mall-pc-payment`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-payment` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-payment` |
| Domain | `commerce` |
| Capability | `payment` |
...
- `pnpm --filter @sdkwork/mall-pc-payment typecheck`

...
This directory is the local standards index for `@sdkwork/mall-pc-invoice`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-invoice` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-invoice` |
| Domain | `commerce` |
| Capability | `invoice` |
...
- `pnpm --filter @sdkwork/mall-pc-invoice typecheck`

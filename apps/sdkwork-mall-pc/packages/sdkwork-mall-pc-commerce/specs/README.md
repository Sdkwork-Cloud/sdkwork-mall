# SDKWork Mall PC React Component Specs

This directory is the local standards index for `@sdkwork/mall-pc-commerce`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-commerce` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-commerce` |
| Domain | `commerce` |
| Capability | `commerce` |

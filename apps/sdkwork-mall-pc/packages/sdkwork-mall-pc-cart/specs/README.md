...
This directory is the local standards index for `@sdkwork/mall-pc-order`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-order` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-order` |
| Domain | `commerce` |
| Capability | `order` |

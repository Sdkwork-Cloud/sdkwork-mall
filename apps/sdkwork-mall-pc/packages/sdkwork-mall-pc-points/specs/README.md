...
This directory is the local standards index for `@sdkwork/mall-pc-points`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-points` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-points` |
| Domain | `commerce` |
| Capability | `points` |
...
- `pnpm --filter @sdkwork/mall-pc-points typecheck`

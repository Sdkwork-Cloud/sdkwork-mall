...
This directory is the local standards index for `@sdkwork/mall-pc-offer`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-offer` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-offer` |
| Domain | `commerce` |
| Capability | `offer` |

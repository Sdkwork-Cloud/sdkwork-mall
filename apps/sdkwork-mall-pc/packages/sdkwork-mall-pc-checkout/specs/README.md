...
This directory is the local standards index for `@sdkwork/mall-pc-checkout`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-checkout` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-checkout` |
| Domain | `commerce` |
| Capability | `checkout` |

...
This directory is the local standards index for `@sdkwork/mall-pc-membership-purchase`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-membership-purchase` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-membership-purchase` |
| Domain | `commerce` |

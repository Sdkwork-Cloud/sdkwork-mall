...
This directory is the local standards index for `@sdkwork/mall-pc-pricing`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-pricing` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-pricing` |
| Domain | `commerce` |
| Capability | `pricing` |

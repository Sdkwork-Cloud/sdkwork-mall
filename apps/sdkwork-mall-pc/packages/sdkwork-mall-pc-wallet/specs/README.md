...
This directory is the local standards index for `@sdkwork/mall-pc-wallet`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-wallet` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-wallet` |
| Domain | `commerce` |
| Capability | `wallet` |
...
- `pnpm --filter @sdkwork/mall-pc-wallet typecheck`

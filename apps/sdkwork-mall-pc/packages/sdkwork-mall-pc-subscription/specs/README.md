...
This directory is the local standards index for `@sdkwork/mall-pc-subscription`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-subscription` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-subscription` |
| Domain | `commerce` |

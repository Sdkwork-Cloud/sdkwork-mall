...
This directory is the local standards index for `@sdkwork/mall-pc-entitlement`.
...
| Type | `react-package` |
| Root | `apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-entitlement` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/mall-pc-entitlement typecheck`

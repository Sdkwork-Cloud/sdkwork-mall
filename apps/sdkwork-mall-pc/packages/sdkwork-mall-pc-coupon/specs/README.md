...
This directory is the local standards index for `@sdkwork/mall-pc-coupon`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-coupon` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-coupon` |
| Domain | `commerce` |
| Capability | `coupon` |

...
This directory is the local standards index for `@sdkwork/mall-pc-membership`.
...
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-membership` |
| Domain | `commerce` |

...
This directory is the local standards index for `@sdkwork/mall-pc-billing`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mall-pc-billing` |
| Type | `react-package` |
| Root | `sdkwork-commerce (deleted)/apps/sdkwork-mall-pc/packages/sdkwork-mall-pc-billing` |
| Domain | `commerce` |
| Capability | `billing` |

# sdkwork-mall Source Configuration
...
| `appId` | `sdkwork-mall` |
| `runtimeCode` | `mall` |
| Config root | `/etc/sdkwork/mall/` |
| Runtime TOML | `/etc/sdkwork/mall/config.toml` |
| Secrets | `/etc/sdkwork/mall/secrets/` |
| Override | `SDKWORK_MALL_CONFIG_FILE` |
